...
export async function updateGreenhouse(greenhouseId, greenhouseGeneticId, dateGreenhouse, transferDate, location, active) {
...
export async function addGreenhouse(greenhouseId, greenhouseGeneticId, dateGreenhouse, transferDate, location, active) {
